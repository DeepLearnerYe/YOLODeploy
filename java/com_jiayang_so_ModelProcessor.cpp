...
#include <exception>
#include "com_jiayang_so_ModelProcessor.h"
...
// JNI implementations
JNIEXPORT jboolean JNICALL Java_com_jiayang_so_ModelProcessor_setLicense(JNIEnv *env, jobject, jstring licenseKey)
{
    if (isLicensed)
    {
...
JNIEXPORT jlong JNICALL Java_com_jiayang_so_ModelProcessor_createDetectionHandler(JNIEnv *env, jobject, jstring modelPath, jlong jgpuNo)
{
...
JNIEXPORT void JNICALL Java_com_jiayang_so_ModelProcessor_destroyDetectionHandler(JNIEnv *env, jobject, jlong handlerPtr)
{
...
JNIEXPORT jbyteArray JNICALL Java_com_jiayang_so_ModelProcessor_detectionInfer(JNIEnv *env, jobject, jlong handlerPtr, jbyteArray imageData)
{
    std::ostringstream oss;
...
JNIEXPORT jlong JNICALL Java_com_jiayang_so_ModelProcessor_createClassificationHandler(JNIEnv *env, jobject, jstring modelPath, jlong jgpuNo)
{
    // std::cout << "createhandler" << std::endl;
    if (!isLicensed)
    {
...
JNIEXPORT void JNICALL Java_com_jiayang_so_ModelProcessor_destroyClassificationHandler(JNIEnv *env, jobject, jlong handlerPtr)
{
    // std::cout << "delete " << std::endl;
    if (!isLicensed || !handlerPtr)
    {
...
JNIEXPORT jbyteArray JNICALL Java_com_jiayang_so_ModelProcessor_classificationInfer(JNIEnv *env, jobject, jlong handlerPtr, jbyteArray imageData, jintArray boxesArray)
{
    std::ostringstream oss;
    // Get the boxes
...
JNIEXPORT jlong JNICALL Java_com_jiayang_so_ModelProcessor_createOrientedBoundingBoxHandler(JNIEnv *env, jobject, jstring modelPath, jlong jgpuNo)
{
    // std::cout << "createhandler" << std::endl;
    if (!isLicensed)
    {
...
JNIEXPORT void JNICALL Java_com_jiayang_so_ModelProcessor_destroyOrientedBoundingBoxHandler(JNIEnv *env, jobject, jlong handlerPtr)
{
    // std::cout << "delete " << std::endl;
    if (!isLicensed || !handlerPtr)
    {
...
JNIEXPORT jbyteArray JNICALL Java_com_jiayang_so_ModelProcessor_orientedBoundingBoxInfer(JNIEnv *env, jobject, jlong handlerPtr, jbyteArray imageData)
{
    std::ostringstream oss;
    // Get the input byte array
    jsize length = env->GetArrayLength(imageData);
