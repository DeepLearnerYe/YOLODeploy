...
JNIEXPORT jlong JNICALL Java_com_jiayang_so_ModelProcessor_createHandler(JNIEnv *env, jobject, jstring modelPath, jlong jgpuNo) {
...
JNIEXPORT void JNICALL Java_com_jiayang_so_ModelProcessor_destroyHandler(JNIEnv *env, jobject, jlong handlerPtr) {
...
JNIEXPORT jbyteArray JNICALL Java_com_jiayang_so_ModelProcessor_infer(JNIEnv *env, jobject, jlong handlerPtr, jbyteArray imageData) {
    ...
    auto objectVec = model->Predict(image);
    model->visualizeRsult(image, objectVec);
